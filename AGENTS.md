...
Every tracked file is part of the public repository surface. Portfolio content
must use anonymized or synthetic material.
...
- Forbidden: the resume source files at repo root, anything outside this
  repository.
